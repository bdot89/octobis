...
const STAT_DISPLAY = [
  ...
  ['flatMeleeDamage', 'Wpn Dmg'], ['apFeral', 'AP (forms)'], ['apVsTarget', 'AP (vs type)'],
...
export const STAT_LABELS = {
  ...
  flatMeleeDamage: 'bonus weapon damage', apFeral: 'attack power in forms', apVsTarget: 'attack power against one creature type',
